...
function uploadProgress(evt) {
    if (evt.lengthComputable) {
        ...
        document.getElementById('progressBar').style.width = (percentComplete * 3.25).toString() + 'px';
        document.getElementById('progressBar').style.border = '1px solid #CCCCCC';
        ...
        if (percentComplete == 100) {
            ...
            uploadResponse.style.display = 'inline';
        }
    }else{
...
function uploadComplete(evt) {
    ...
    uploadResponse.style.display = 'inline';
    document.getElementById('info-upload').innerHTML = '';
}  
